...
######################
  ...
  master.vm.provider :virtualbox do |settings|
    ...
    settings.name = "c7master_2016.2.0"
    settings.cpus = 2
  end
...
###################
  ...
  config.vm.define 'development' do |development|
    development.vm.box = 'puppetlabs/centos-7.0-64-nocm'
  ...
  development.vm.provider :virtualbox do |settings|
    settings.memory = 512
    settings.name = "c7development_2016.2.0"
    settings.cpus = 1
  end
...
###################
  ...
  config.vm.define 'production' do |production|
    production.vm.box = 'puppetlabs/centos-7.0-64-nocm'
  ...
  production.vm.provider :virtualbox do |settings|
    settings.memory = 512
    settings.name = "c7production_2016.2.0"
    settings.cpus = 1
  end
